...
En la _Biblioteca_ podés ver el objeto `TimbaElLeon`. Para resolver este ejercicio, no nos interesa cómo están implementados los métodos de este objeto, solo queremos recordar los mensajes que entiende ¡por eso hay puntos suspensivos! :sunglasses:
